 ...
 * readingFilesOne
 */
public class readingFilesThree {
    ...
    public static void main(String[] args) throws IOException {         // Need to tell java that you're okay if main throws an IOException. Will happen when the selected file cannot be read.
        ...
        s.useDelimiter("\\.");                                          // We can also set a delimiter to use. In this case, we use a ".", represented by "\\." Now java will print the file out as normal, but when there is a period, a new line will be printed.
